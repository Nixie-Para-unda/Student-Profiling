...
const fetchStudents = async () => {
  ...
  try {
    ...
    // --> NEW CODE: Reads the URL and sets the dropdown filter automatically
    if (route.query.subject) {
      // If your subject IDs are numbers, it's safer to convert the string from the URL
      filterSubject.value = Number(route.query.subject) || route.query.subject
    }
