...
import FacultySubjects from '../views/faculty/FacultySubjects.vue'
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('../views/faculty/FacultySubjects.vue'), // Assuming subjects use same view or update later
