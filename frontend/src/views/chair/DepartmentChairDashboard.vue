    ...
    <div class="bottom-grid">
      ...
      <div class="card">
        ...
        <div class="violation-alert">
          ...
          <router-link to="/chair/awards" style="background:none;border:none;color:#FF6B1A;font-size:11px;font-weight:600;cursor:pointer;font-family:'Outfit',sans-serif;text-decoration:none">Approve Now →</router-link>
        </div>
      </div>
    </div>
  </div>
...
const stats = ref([
  { label: 'Total Students', value: '842', delta: 'Enrolled', deltaClass: 'positive', fill: '100%', iconBg: '#fff5ef', iconColor: '#FF6B1A', route: '/chair/students', iconPath: '<path d="M9 8a3 3 0 100-6 3 3 0 000 6zM2 16a7 7 0 0114 0" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>' },
