...
const stats = ref([
  { label: 'Total Students', value: '842', delta: 'Enrolled', deltaClass: 'positive', fill: '100%', iconBg: '#fff5ef', iconColor: '#FF6B1A', route: '/secretary/students', iconPath: '<path d="M9 8a3 3 0 100-6 3 3 0 000 6zM2 16a7 7 0 0114 0" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>' },
  ...
  { label: 'Pending Accounts', value: '5', delta: 'To create', deltaClass: 'warning', fill: '30%', iconBg: '#f5f3ff', iconColor: '#8b5cf6', route: '/secretary/students', iconPath: '<path d="M9 1v10M9 1L6 4M9 1l3 3M2 13h14" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>' },
