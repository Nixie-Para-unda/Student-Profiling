...
.filter-tab { display: flex; align-items: center; gap: 6px; padding: 8px 16px; border: none; background: none; border-radius: 9px; font-size: 13px; font-weight: 600; color: #9a8070; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: all 0.15s; }
...
.approve-btn { display: flex; align-items: center; gap: 5px; background: #f0fdf4; color: #16a34a; border: 1.5px solid #bbf7d0; border-radius: 8px; padding: 7px 14px; font-size: 12px; font-weight: 600; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: all 0.15s; }
.approve-btn:hover { background: #16a34a; color: #fff; }
.approve-btn svg { width: 13px; height: 13px; }
.reject-btn { display: flex; align-items: center; gap: 5px; background: #fff1f2; color: #ef4444; border: 1.5px solid #fecdd3; border-radius: 8px; padding: 7px 14px; font-size: 12px; font-weight: 600; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: all 0.15s; }
